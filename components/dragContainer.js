...
import DragLayoutContent from './dragLayoutContent'
...
class DragContainer extends React.Component {
    ...
    //     this.setState({ shape: nextProps.shape })
    // }
    componentWillMount() {
    ...
    */
    ...
    render() {
        ...
        return <div className={shape ? "container drag-outline" : "container"} style={style} onMouseDown={e => this.startHandler(e)}>
            <DragLayoutContent parentLeft={left} parentTop={top} />
            {shape && <div>
