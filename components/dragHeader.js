...
import DragLayoutTitle from './dragLayoutTitle'

class DragHeader extends React.Component {
    state = {
        withinX: 0,
        withinY: 0,
        left: 420,
    ...
    render() {
        ...
        return <div className={shape ? "header drag-outline" : "header"} style={style} onMouseDown={e => this.startHandler(e)}>
            <DragLayoutTitle  parentLeft={left} parentTop={top} />
            {shape && <div>
